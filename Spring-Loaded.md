...
1.2.8 has now been released: [springloaded-1.2.8.RELEASE.jar](http://repo.spring.io/release/org/springframework/springloaded/1.2.8.RELEASE/springloaded-1.2.8.RELEASE.jar)

1.2.9 snapshots are in this repo area (grab the most recently built .jar):
<a href="https://repo.spring.io/webapp/#/artifacts/browse/tree/General/libs-snapshot-local/org/springframework/springloaded/1.2.9.BUILD-SNAPSHOT">repo.spring.io</a>
